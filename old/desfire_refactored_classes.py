...
def ejemplo_uso_completo():
    ...
    try:
        ...
        # 4. Crear aplicación de control de acceso
        print("\n3. Creando aplicación de control de acceso...")
        ...
        # 5. Autenticarse en aplicación de monedero
        print("\n4. Autenticándose en aplicación de monedero...")
